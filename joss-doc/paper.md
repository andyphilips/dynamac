...
Specifically, dynamac implements six new visualizations. These can be presented individually using `dynardl.simulation.plot()`, or all together using the command `dynardl.all.plots()`. The resulting plots are:
